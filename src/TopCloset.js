...
function TopCloset(props) {
  return (
    <div>
        <img src={image1} className='image' onClick={() => props.changeImage(closed1)} alt=""/>
        <img src={image2} className='image' onClick={() => props.changeImage(closed2)} alt=""/>
        <img src={image3} className='image' onClick={() => props.changeImage(closed3)} alt=""/>
        <img src={image4} className='image' onClick={() => props.changeImage(closed4)} alt=""/>
        <img src={image5} className='image' onClick={() => props.changeImage(closed5)} alt=""/>
    </div>
  );
}
